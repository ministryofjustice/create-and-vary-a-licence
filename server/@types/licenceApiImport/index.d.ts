...
export interface paths {
  ...
  '/licence/id/{licenceId}/hdc/curfew/address': {
    parameters: {
      query?: never
      header?: never
      path?: never
  ...
  '/licence/id/{licenceId}/hdc-first-night-curfew-times': {
    parameters: {
      query?: never
      header?: never
      path?: never
    ...
    get?: never
    /**
     * Update the HDC first-night curfew times for a licence.
     * @description Replace the first-night curfew times for a HDC licence. Requires ROLE_CVL_ADMIN.
     */
    put: operations['updateFirstNightCurfewTimes']
    post?: never
    delete?: never
    options?: never
    head?: never
  ...
  '/probation-staff/case-access': {
    ...
    put?: never
    /**
     * Returns the access arrangements for a probation staff member based on the case information provided.
     * @description Returns the access arrangements for a probation staff member based on the case information provided.
     */
    post: operations['checkComCaseAccess']
    delete?: never
    options?: never
    head?: never
    patch?: never
  ...
  '/licences/migrate/active': {
    ...
    put?: never
    /**
     * Migrate a single active licence from HDC to CVL
     * @description Triggers migration of the supplied data into CVL
     */
    post: operations['migrateLicenceToCvl']
    delete?: never
    options?: never
    head?: never
    patch?: never
  ...
  '/jobs/deactivate-progression-licences': {
    parameters: {
      query?: never
      header?: never
      path?: never
    ...
    put?: never
    /**
     * Deactivate licences not on policy version 4 which have licence start dates beyond the policy version 4 go-live date.
     ...
     */
    post: operations['runDeactivateProgressionLicencesJob']
    delete?: never
    options?: never
    head?: never
    patch?: never
  ...
  '/address/search/by/text/': {
     ...
     */
    post: operations['searchForAddressesWithPost']
    delete?: never
    options?: never
    head?: never
    patch?: never
  ...
  '/probation-staff/{crn}/permissions': {
    parameters: {
      query?: never
      header?: never
      path?: never
    ...
    /**
     * Returns the access arrangements for a probation staff member based on the CRN provided.
     * @description Returns the access arrangements for a probation staff member based on the CRN provided.
     */
    get: operations['getDetailsForExcludedOrRestrictedCase']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/offender/nomisid/{nomsId}/support-info': {
    parameters: {
      query?: never
      header?: never
      path?: never
    ...
    /**
     * Retrieve support information for offender
...
export interface components {
  schemas: {
    ...
    TimeServedProbationConfirmContactRequest: {
      ...
      otherCommunicationDetail?: string | null
    }
    ...
    OverrideLicenceDatesRequest: {
      /**
       * @description The updated licence kind based on the current dates
       * @example CRD
       * @enum {string}
       */
       ...
       * @enum {string}
       */
      updatedEligibleKind: 'CRD' | 'HDC' | 'FIXED_TERM' | 'STANDARD'
      /**
       * Format: date
    ...
    AddHdcCurfewAddressRequest: {
       ...
       * @enum {string}
       */
      accommodationType: 'CAS' | 'RESIDENTIAL'
      /**
       * @description Flag to indicate if post release residential checks have been completed
       * @example true
       */
      postReleaseResidentialChecksCompleted?: boolean | null
      /**
       * @description Reason for post release checks not completed, required if postReleaseResidentialChecksCompleted is false
       * @example Offender refused to provide information
       */
    ...
    /**
     * @description "Request object for check whether a user has access to a case. One of crn, nomisId or licenceId must be provided.
    ...
    CheckCaseAccessRequest: {
      ...
      crn?: string | null
      /**
       * @description The nomis number associated with the case
       * @example A1234AA
       */
      nomisId?: string | null
      /**
       * Format: int64
       * @description The id of the licence to check access to
       * @example 8947
       */
      licenceId?: number | null
    }
    /** @description Details about case access restrictions for a probation staff member */
    CaseAccessDetails: {
      /**
       * @description The CRN of the case
       * @example X320741
       */
      crn: string
      /**
       * @description The type of access restriction
       * @example RESTRICTED
       * @enum {string}
       */
      type: 'RESTRICTED' | 'EXCLUDED' | 'NONE'
      /**
    ...
    UpdateElectronicMonitoringProgrammeRequest: {
      ...
      isToBeTaggedForProgramme?: boolean | null
      /**
    ...
    AddAdditionalConditionRequest: {
       ...
       * @example You must not enter the locations
       */
      conditionTextPlural?: string | null
      /**
    ...
    AdditionalCondition: {
      ...
      readyToSubmit?: boolean | null
      /** @description Whether the condition requires input from the user */
      requiresInput?: boolean | null
      /** @description An additional caption to appear above the header of this additional condition */
    ...
    VaryApproverCase: {
       ...
       * @example 30/11/2022
       */
      variationRequestDate?: string | null
      /**
       * Format: date
       * @description The date on which the prisoner leaves custody
       * @example 30/11/2022
    ...
    ApprovalCase: {
       ...
       * @enum {string|null}
       */
      kind?: 'PRRD' | 'CRD' | 'VARIATION' | 'HARD_STOP' | 'HDC' | 'HDC_VARIATION' | 'TIME_SERVED' | null
      /**
       * @description The agency code where this offender resides or was released from
       * @example LEI
       */
    ...
    ComCreateCase: {
      ...
      isRestricted: boolean
      /**
       * @description The current status of the HDC case
       * @example APPROVED
       * @enum {string}
       */
      hdcStatus:
    ...
    CaCase: {
       ...
       * @enum {string|null}
       */
      tabType?: 'RELEASES_IN_NEXT_TWO_WORKING_DAYS' | 'FUTURE_RELEASES' | 'ATTENTION_NEEDED' | null
      /**
       * @description Legal Status
       * @example SENTENCED
       * @enum {string|null}
    ...
    CvlFields: {
       ...
       * @enum {string|null}
       */
      licenceKind?: 'PRRD' | 'CRD' | 'VARIATION' | 'HARD_STOP' | 'HDC' | 'HDC_VARIATION' | 'TIME_SERVED' | null
      /**
       * @description The kind of licence this person is eligible for based on their current dates
       * @example CRD
       * @enum {string|null}
       */
      eligibleKind?: 'CRD' | 'HDC' | 'FIXED_TERM' | 'STANDARD' | null
      /**
       * @deprecated
       ...
       * @enum {string|null}
       */
      hardStopKind?: 'PRRD' | 'CRD' | 'VARIATION' | 'HARD_STOP' | 'HDC' | 'HDC_VARIATION' | 'TIME_SERVED' | null
      /** @description A boolean flag denoting whether the licence is for a time served case */
    ...
    RecallSupportInfo: {
       ...
       * @enum {string}
       */
      recallType: 'STANDARD' | 'FIXED_TERM' | 'NONE'
      /**
       * @description The name of the recall
       * @example Standard Recall
       */
      recallName: string
      /**
       * @description Fixed term recall types
       * @example FTR_ORA
       */
      fixTermSentenceTypes: string[]
      /**
       * @description Standard recall types
       * @example LR
       */
      standardRecallSentenceTypes: string[]
      /**
       * @description Other sentence types
       * @example ADIMP_ORA]
       */
    ...
    > & {
      ...
      electronicMonitoringProvider?: components['schemas']['ElectronicMonitoringProvider'] | null
    } & {
      /**
       * @description discriminator enum property added by openapi-typescript
       * @enum {string}
    ...
    > & {
       ...
       * @enum {string|null}
       */
      eligibleKind?: 'CRD' | 'PRRD' | 'TIME_SERVED' | null
      /**
       * @description The version number used for standard and additional conditions
       * @example 1.4
       */
    ...
    > & {
      ...
      curfewAddress?: components['schemas']['HdcCurfewAddress'] | null
      /** @description Describes a electronic monitoring provider on a licence */
      electronicMonitoringProvider?: components['schemas']['ElectronicMonitoringProvider'] | null
      /** @description Are all curfew times equal across the week */
      allCurfewTimesEqual?: boolean | null
      /**
       * @description Has this licence been migrated from the HDC service?
       * @example false
       */
    ...
    ConditionalInput: {
      ...
      name: string
      /** @enum {string|null} */
      case?: 'lower' | 'upper' | 'capitalised' | null
    ...
    Input: {
      ...
      case?: 'lower' | 'upper' | 'capitalised' | null
      handleIndefiniteArticle?: boolean | null
      addAnother?: components['schemas']['AddAnother'] | null
      includeBefore?: string | null
      subtext?: string | null
      defaultValue?: string | null
      hideHintText: boolean
    ...
    Option: {
      value: string
      conditional?: components['schemas']['Conditional'] | null
    }
    StandardConditionAp: {
      /**
    ...
    LastMinuteHandoverCaseResponse: {
      ...
      probationPractitioner?: string | null
      /**
       * @description Current licence status of the case
       * @example IN_PROGRESS
       * @enum {string}
    ...
    Case: {
       ...
       * @enum {string|null}
       */
      kind?: 'CRD' | 'HDC' | 'FIXED_TERM' | 'STANDARD' | null
    }
    ...
    ProbationCase: {
      ...
      crn: string
      /**
       * @description True if the offender has a COM allocated to them
       * @example true
       */
      comAllocated: boolean
      /**
       * @description Prisoner Number
       * @example A1234AA
       */
...
export interface operations {
  ...
  addHdcCurfewAddress: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['AddHdcCurfewAddressRequest']
      }
    }
    responses: {
  ...
  updateFirstNightCurfewTimes: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['UpdateFirstNightCurfewTimesRequest']
      }
    }
    responses: {
  ...
  checkComCaseAccess: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['CheckCaseAccessRequest']
      }
    }
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': components['schemas']['CaseAccessDetails']
        }
      }
      /** @description Bad Request */
      400: {
  ...
  migrateLicenceToCvl: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['MigrateFromHdcToCvlRequest']
      }
    }
    responses: {
  ...
  runDeactivateProgressionLicencesJob: {
    parameters: {
      query?: never
      header?: never
      path?: never
  ...
  searchForAddressesWithPost: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['AddressSearchRequest']
      }
    }
    responses: {
  ...
  getDetailsForExcludedOrRestrictedCase: {
    parameters: {
      query?: never
      header?: never
      path: {
