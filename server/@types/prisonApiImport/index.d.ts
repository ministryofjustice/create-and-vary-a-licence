...
export interface operations {
  ...
  getOffenderBookings: {
    parameters: {
      query: {
        /** Search parameters with the format [connector]:&ltfieldName&gt:&ltoperator&gt:&ltvalue&gt:[format],... <p>Connector operators - and, or <p>Supported Operators - eq, neq, gt, gteq, lt, lteq, like, in</p> <p>Supported Fields - bookingNo, bookingId, offenderNo, firstName, lastName, agencyId, assignedLivingUnitId, assignedOfficerUserId</p> */
        query?: string
  ...
  getOffenderAlerts: {
    parameters: {
      ...
      query: {
        /** Search parameters with the format [connector]:&ltfieldName&gt:&ltoperator&gt:&ltvalue&gt:[format],... <p>Connector operators - and, or <p>Supported Operators - eq, neq, gt, gteq, lt, lteq, like, in</p> <p>Supported Fields - alertType, alertCode, dateCreated, dateExpires</p> */
        query: string
      }
      header: {
  ...
  getOffendersAtLocation: {
    parameters: {
      ...
      query: {
        /** Search parameters with the format [connector]:&ltfieldName&gt:&ltoperator&gt:&ltvalue&gt:[format],... <p>Connector operators - and, or <p>Supported Operators - eq, neq, gt, gteq, lt, lteq, like, in</p> <p>Supported Fields - bookingNo, bookingId, offenderNo, firstName, lastName, agencyId, or assignedLivingUnitId</p> */
        query: string
      }
      header: {
        /** Requested offset of first record in returned collection of inmate records. */
  ...
  getAlertsByOffenderNoUsingGET: {
    parameters: {
      ...
      query: {
        ...
        latestOnly?: boolean
        /** Search parameters with the format [connector]:&ltfieldName&gt:&ltoperator&gt:&ltvalue&gt:[format],... <p>Connector operators - and, or <p>Supported Operators - eq, neq, gt, gteq, lt, lteq, like, in</p> <p>Supported Fields - alertId, bookingId, alertType, alertCode, comment, dateCreated, dateExpires, active</p> */
        query?: string
      }
      header: {
