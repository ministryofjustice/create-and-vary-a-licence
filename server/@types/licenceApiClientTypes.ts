...
export type SubmitLicenceRequest = components['schemas']['SubmitLicenceRequest']
export type UpdateResponsibleComRequest = components['schemas']['UpdateResponsibleComRequest']
