...
export type LicencePolicy = components['schemas']['LicencePolicy']
...
export type AdditionalConditions = components['schemas']['AdditionalConditions']
export type AdditionalConditionAp = components['schemas']['AdditionalConditionAp']
export type AdditionalConditionPss = components['schemas']['AdditionalConditionPss']
export type Input = components['schemas']['Input']
export type LicenceConditionChange = components['schemas']['LicenceConditionChange']
