...
export default function Index({ licenceService, conditionService, addressService }: Services): Router {
...

  {
    ...
    get('/create/id/:licenceId/licence-contact-address', controller.GET, UserType.PROBATION)
...

  {
    ...
    post('/view/id/:licenceId/initial-meeting-place', controller.POST, PostcodeLookupInputValidation)
  }

  {
    ...
    get('/create/id/:licenceId/licence-contact-number', controller.GET, UserType.PROBATION)
