...
import { AppointmentTimeType } from '../../../enumeration'

const render = templateRenderer(
  fs.readFileSync('server/views/pages/initialAppointment/initialMeetingTime.njk').toString(),
)

describe('Initial appointment page accessibility', () => {
  afterEach(() => {
    jest.resetAllMocks()
  })
