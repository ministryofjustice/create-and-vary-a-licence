...
describe('Licence Service', () => {
  ...
  describe('Create Licence', () => {
    beforeEach(() => {
      ...
      conditionService.expandAdditionalCondition.mockResolvedValue('condition')
      licenceApiClient.getConditions.mockResolvedValue({} as LicencePolicyResponse)
      licenceApiClient.getActiveConditions.mockResolvedValue({} as LicencePolicyResponse)
