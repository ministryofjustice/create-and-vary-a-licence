  ...
  e2e: {
    setupNodeEvents(on) {
      on('task', {
        ...
        stubPostPrisonLicence: licence.stubPostPrisonLicence,
        stubPostProbationLicence: licence.stubPostProbationLicence,
        ...
        stubGetComSearchResponses: licence.stubSearchForOffenderOnStaffCaseload,
