...
context('Vary a HDC licence', () => {
  ...
  it('should click through vary a HDC licence journey', () => {
    ...
    const reasonForVariationPage = checkAnswersPage
      .clickAddVariationNotes()
      .verifyGuidanceText()
      .enterReason('In December Mr Person failed a drug test at Drug Rehab Clinic and tested positive for cocaine.')
    const variationSummaryPage = reasonForVariationPage.clickContinue()
    variationSummaryPage
      .verifyPageHeading()
