...
export HDC_LICENCE_CREATION_BLOCK=true
export CA_NEW_SEARCH_ENABLED=true
export SHOW_DPR_REPORTING=true
...
# === Boolean flags ===
  ...
  HDC_LICENCE_CREATION_BLOCK=$HDC_LICENCE_CREATION_BLOCK
  CA_NEW_SEARCH_ENABLED=$CA_NEW_SEARCH_ENABLED
  SHOW_DPR_REPORTING=$SHOW_DPR_REPORTING
